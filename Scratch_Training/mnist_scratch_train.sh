...
#SBATCH --job-name="MNIST scratch Training"
...
python3 /home/mohan235/projects/def-guzdial/mohan235/1_Mohan_GRAF_Work/Image_tasks_PSTL/Scratch_Training/mnist_scratch_train.py >> mnist_scratch_train_log.txt 2>&1

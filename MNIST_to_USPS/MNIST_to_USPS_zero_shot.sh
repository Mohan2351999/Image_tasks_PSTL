...
#SBATCH --job-name="MNIST to USPS zero shot"
...
python3 /home/mohan235/projects/def-guzdial/mohan235/1_Mohan_GRAF_Work/Image_tasks_PSTL/MNIST_to_USPS/MNIST_to_USPS_zero_shot.py >> MNIST_to_USPS_zero_shot_log.txt 2>&1
...
#SBATCH --job-name="MNIST to USPS search transfer"
...
python3 /home/mohan235/projects/def-guzdial/mohan235/1_Mohan_GRAF_Work/Image_tasks_PSTL/MNIST_to_USPS/MNIST_to_USPS_search_transfer.py >> MNIST_to_USPS_search_transfer_log.txt 2>&1
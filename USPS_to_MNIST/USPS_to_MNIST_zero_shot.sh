...
#SBATCH --job-name="USPS to MNIST zero shot"
...
python3 /home/mohan235/projects/def-guzdial/mohan235/1_Mohan_GRAF_Work/Image_tasks_PSTL/USPS_to_MNIST/USPS_to_MNIST_zero_shot.py >> USPS_to_MNIST_zero_shot_log.txt 2>&1
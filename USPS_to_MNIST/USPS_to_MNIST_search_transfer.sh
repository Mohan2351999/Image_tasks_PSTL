...
#SBATCH --job-name="USPS to MNIST search transfer"
...
python3 /home/mohan235/projects/def-guzdial/mohan235/1_Mohan_GRAF_Work/Image_tasks_PSTL/USPS_to_MNIST/USPS_to_MNIST_search_transfer.py >> USPS_to_MNIST_search_transfer_log.txt 2>&1
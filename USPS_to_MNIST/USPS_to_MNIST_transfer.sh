...
#SBATCH --job-name="USPS to MNIST transfer"
...
python3 /home/mohan235/projects/def-guzdial/mohan235/1_Mohan_GRAF_Work/Image_tasks_PSTL/USPS_to_MNIST/USPS_to_MNIST_transfer.py >> USPS_to_MNIST_transfer_log.txt 2>&1